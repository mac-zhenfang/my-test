...
/**
 * @author zhefang 1. Make schema 2. Use Writer to write file
 */
public class AvroTest {
	...
	public static GenericData.Record makeObject(Schema schema, String name,
			int age) {
	...
	public static void testWrite(File file, Schema schema) throws IOException {
		GenericDatumWriter<GenericData.Record> datum = new GenericDatumWriter<GenericData.Record>(
				schema);
	...
	public static void main(String[] args) throws IOException {
		...
		File file = new File("C:\\test-file.avro");
